...
const OrderDetails = () => {
    ...
    if (!order) {
        return (
            <div className="text-center py-40 text-gray-400">Order not found.</div>
        );
    }
    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-10">
            <div className="flex items-center justify-between mb-8">
                ...
                <span
                    className={`px-3 py-1 rounded-full text-sm font-medium capitalize ${statusColors[order.status]
                    }`}
                    >
                    {order.status}
                </span>
